      ...
      <section className="inventory-manager ss-card">
        ...
        <div className="coupon-grid">
          <article className="coupon-form-card">
            ...
            <label data-tooltip="Short note explaining what this coupon represents.">Description<textarea value={draft.description} onChange={event => setDraft(current => ({ ...current, description: event.target.value }))} placeholder="What this coupon is for" /></label>
